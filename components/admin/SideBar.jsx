...
export default function SideBar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: 'Manage Services', path: '/service-list' },
    ...
    },
    {
      ...
      submenu: [
        { name: 'Return Orders 1', path: '#' },
        { name: 'Return Orders 2', path: '#' },
        { name: 'Return Orders 3', path: '#' },
      ]
    },
    {
      name: 'Campaigns',
      ...
      submenu: [
        ...
        { name: 'Campaign List', path: '/campaign-list' },
    ...
    },
    {
      ...
      submenu: [
        { name: 'Analytics 1', path: '#' },
        { name: 'Analytics 2', path: '#' },
        { name: 'Analytics 3', path: '#' }
      ]
    },
    {
      name: 'My Account',
  ...
  const filteredMenuItems = menuItems.filter(item =>
    ...
    (item.submenu && item.submenu.some(sub => sub.name.toLowerCase().includes(searchText)))
  );
