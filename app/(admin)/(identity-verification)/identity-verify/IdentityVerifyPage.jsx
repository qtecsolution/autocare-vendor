    ...
    if (!sellerImage) {
      ...
      try {
        const response = await axiosInstance.post(
          "/seller-panel-api/seller-identity-verification/",
          formData,
          {
            headers: {
                ...
                <div className="login-form">
                  ...
                  <form className="form-inner">
                    <div className="login-checkbox-inner">
                      <p className="text">Choose ID type</p>
                      <div>
                        <input
              ...
              <div className="right">
                <div className="login-form">
                  <div className="d-flex flex-column gap-3">
                    ...
                    <p className="form-details">
                      Make sure your photos are not blurry and it shows you face
                      clearly.
                    </p>
                  </div>
                      ...
                      <div className="d-flex flex-column gap-2">
                        ...
                        <label for="frontPart" className="upload-card">
                          ...
                          <input
                            ...
                            onChange={handleFrontPartUpload}
                          />
                        </label>
                      </div>
          ...
          <div className="container">
            <div className="login-section-inner d-flex justify-content-center align-items-center">
              <div className="right">
                <div className="login-form">
                  <div className="d-flex flex-column gap-3">
                    <h1 className="form-title">Vendor Profile Image</h1>
                    <p className="form-details">
                      Make sure your photos are not blurry and it shows you face
                      clearly.
                    </p>
                  ...
                  <div className="form-inner">
                    ...
                    <button
                      ...
                      className={`login-btn ${
                        check3rdButtonDisable() ? "show_disable_button" : ""
                      }`}
                      disabled={check3rdButtonDisable()}
                    >
                      Continue
                    </button>
                  </div>
