          ...
          <div className="row g-4">
              ...
              <div className="sales-details-cart">
                ...
                <div className="bottom-content">
                  <div className="bottom-content-text">
                    <h2 className="number">{dashBoardInfo?.props?.dashboardinfo?.report?.revenue}</h2>
            ...
            <div className="col-md-6">
              <div className="sales-details-cart">
                ...
                <div className="bottom-content">
                  <div className="bottom-content-text">
                    <h2 className="number">{dashBoardInfo?.props?.dashboardinfo?.report?.total_order}</h2>
                    {/* <div className="increase-inner">
                      <figure className="increase-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
            ...
            <div className="col-md-6">
              <div className="sales-details-cart">
                ...
                <div className="bottom-content">
                  <div className="bottom-content-text">
                    <h2 className="number">{dashBoardInfo?.props?.dashboardinfo?.report?.total_service_booking}</h2>
                    {/* <div className="increase-inner">
                      <figure className="increase-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
            ...
            <div className="col-lg-8">
              <div className="d-flex flex-column gap-4">
                ...
                <div className="recent-notification-inner">
                  {dashBoardInfo?.props?.dashboardinfo?.notification?.map((notification) => (
                    <div className="recent-notification-inner-cart" key={notification?.id}>
                      <div className="d-flex gap-3">
                        ...
                        <div className="cart-content">
                          <div className="d-flex flex-column gap-2">
                            <div className="d-flex flex-column gap-1">
                              <h3 className="title">{notification?.message}</h3>
                      ...
                      <div className="notification-inner-cart-right">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <p className="notification-time">{moment(notification?.created_at).format('MMMM Do YYYY, h:mm:ss a')}</p>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="badges-inner">
                  ...
                  <div className="d-flex flex-wrap gap-3">
                    {dashBoardInfo?.props?.dashboardinfo?.earned_badges?.map((earnedBadge) => (
                      <div key={earnedBadge?.id} className={`badge ${colorBadge[Math.floor(Math.random() * dashBoardInfo?.props?.dashboardinfo?.earned_badges?.length)]}`}>
                        <figure className="badge-img">
                          <img src={earnedBadge?.icon} width={15} height={15} />
                        </figure>
