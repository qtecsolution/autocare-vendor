...
function DashBoardPage({ dashBoardInfo }) {
  ...
  const percentageOfSetup =
    dashBoardInfo?.props?.dashboardinfo?.profile_setup?.percentage;
  const isProfileSetupCompleted =
    dashBoardInfo?.props?.dashboardinfo?.profile_setup
      ?.is_profile_setup_completed;
  const isStoreSetupCompleted =
    dashBoardInfo?.props?.dashboardinfo?.profile_setup
      ?.is_store_setup_completed;
  const isBillingSetupCompleted =
    dashBoardInfo?.props?.dashboardinfo?.profile_setup
      ?.is_billing_setup_completed;
  return (
    <div id="content">
                    ...
                    <div class="inner-bar-chart">
                      <div class="bar-chart">
                        <div class="bar" style={{ width: "100%" }}>
                          <span
                            style={{
                              width: `${percentageOfSetup}%`,
                            }}
                          ></span>
                        </div>
                      </div>
                      <p class="text">{percentageOfSetup}%</p>
                    </div>
                  </div>
