...
export default function Settings() {
  ...
  const [isConfirmModalOpen3, setIsConfirmModalOpen3] = useState(false);
  ...
  const handleUserUpdate = async () => {
    ...
    if (user.phone2.length > 0 && !phoneNumberRegex.test(user.phone2)) {
      toast.custom((t) => (
        <AlertToast
  ...
  return (
    <>
      ...
      <ConfirmModal
        isOpen={isConfirmModalOpen1}
        title="Profile Update"
        message="Are you sure you want to update your profile?"
        onConfirm={handleUserUpdate}
        onClose={closeConfirmModal1}
        button_name="Update Profile"
      />
      <ConfirmModal
        isOpen={isConfirmModalOpen2}
        title="Bussiness Info Update"
        message="Are you sure you want to update your Bussiness Info?"
        onConfirm={handleBusinessUpdate}
        onClose={closeConfirmModal2}
        button_name="Update Bussiness"
      />
      <ConfirmModal
        isOpen={isConfirmModalOpen3}
