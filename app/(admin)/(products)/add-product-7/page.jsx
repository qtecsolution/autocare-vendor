    ...
    <div class="d-flex flex-column h-100">
      <div class="flex-grow-1">
                      ...
                      <label class="promotion-image-uploader" for="promotion-image">
                        ...
                        <div class="d-flex align-items-center flex-column gap-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34"
                            fill="none">
                            <path
                              d="M17.0001 23.375V13.8125M17.0001 13.8125L21.2501 18.0625M17.0001 13.8125L12.7501 18.0625M9.5626 27.625C8.04596 27.6267 6.57842 27.0875 5.42352 26.1045C4.26862 25.1214 3.50203 23.7588 3.26142 22.2614C3.0208 20.764 3.32193 19.2298 4.11072 17.9344C4.89951 16.6391 6.12429 15.6673 7.5651 15.1938C7.19492 13.2971 7.5775 11.3308 8.63182 9.71129C9.68614 8.09177 11.3294 6.94621 13.2137 6.51718C15.0979 6.08815 17.0751 6.40934 18.7267 7.41274C20.3782 8.41614 21.5744 10.023 22.0618 11.8929C22.8155 11.6478 23.6227 11.6183 24.3923 11.8078C25.1618 11.9972 25.8631 12.3981 26.4168 12.9651C26.9706 13.5321 27.3547 14.2427 27.5259 15.0165C27.6971 15.7903 27.6486 16.5966 27.3857 17.3443C28.5454 17.7873 29.5135 18.6222 30.1221 19.7044C30.7306 20.7865 30.9411 22.0475 30.7172 23.2686C30.4932 24.4897 29.8489 25.5939 28.8959 26.3896C27.943 27.1854 26.7416 27.6224 25.5001 27.625H9.5626Z"
                              stroke="#0D9488" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                          </svg>
                          <p>Drop your video here or</p>
                          <span>Browse</span>
                        </div>
                      </label>
                    </div>
            ...
            <div class="main-description">
              ...
              <div class="editor-container">
                <div id="toolbar">
                  ...
                  <a class="link-example" href="#">See Example</a>
                </div>
                <div id="editor"></div>
              </div>
            </div>
        ...
        <div class="price-section">
          <div class="inner-price-section">
            <div class="row">
              ...
              <div class="col-3">
                <div class="inner-input">
                  <label class="label" for="">Free Items
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path
                          d="M9.375 9.375L9.40917 9.35833C9.51602 9.30495 9.63594 9.2833 9.75472 9.29596C9.8735 9.30862 9.98616 9.35505 10.0794 9.42976C10.1726 9.50446 10.2424 9.60432 10.2806 9.71749C10.3189 9.83066 10.3238 9.95242 10.295 10.0683L9.705 12.4317C9.67595 12.5476 9.68078 12.6695 9.71891 12.7828C9.75704 12.8961 9.82687 12.9961 9.92011 13.071C10.0134 13.1458 10.1261 13.1923 10.245 13.205C10.3639 13.2177 10.4839 13.196 10.5908 13.1425L10.625 13.125M17.5 10C17.5 10.9849 17.306 11.9602 16.9291 12.8701C16.5522 13.7801 15.9997 14.6069 15.3033 15.3033C14.6069 15.9997 13.7801 16.5522 12.8701 16.9291C11.9602 17.306 10.9849 17.5 10 17.5C9.01509 17.5 8.03982 17.306 7.12987 16.9291C6.21993 16.5522 5.39314 15.9997 4.6967 15.3033C4.00026 14.6069 3.44781 13.7801 3.0709 12.8701C2.69399 11.9602 2.5 10.9849 2.5 10C2.5 8.01088 3.29018 6.10322 4.6967 4.6967C6.10322 3.29018 8.01088 2.5 10 2.5C11.9891 2.5 13.8968 3.29018 15.3033 4.6967C16.7098 6.10322 17.5 8.01088 17.5 10ZM10 6.875H10.0067V6.88167H10V6.875Z"
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="inner-input">
                        ...
                        <input class="input" type="number" name="" id="" placeholder="" />
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="inner-input">
                        <label class="label" for="">Seller SKU
                          <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                              fill="none">
                              <path
        ...
        <div class="variant-name">
          <div class="inner-variant-name">
            <div class="row">
              <div class="col-6">
                <div class="variant-select">
                  <div class="box">
                    <label class="variant-select-label">Select Category
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                          fill="none">
                          <path
                      ...
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                          ...
                          <path
                            ...
                            stroke="#7B7F95" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                      </span>
                    </div>
        ...
        <div class="packaging-section">
          <div class="inner-packaging-section">
            {/* <!-- <div class="row">
              <div class="col-4">
                <label for="">
                  Package Weight <span>*</span>
                </label>
            ...
            <div class="row">
              <div class="col-4">
                <div class="inner-input">
                  <label class="label" for="length">Package length (cm) <span>*</span></label>
                  <input class="input" type="text" name="" id="length" placeholder="Ex. 200" />
                </div>
              </div>
              <div class="col-4">
                <div class="inner-input">
                  <label class="label" for="Weight">Weight (kg) <span>*</span></label>
                  <input class="input" type="text" name="" id="Weight" placeholder="Ex. Sony a6400" />
                </div>
              </div>
              <div class="col-4">
                <div class="inner-input">
                  <label class="label" for="Height">Height (cm) <span>*</span></label>
                  <input class="input" type="text" name="" id="Height" placeholder="0.1" />
                </div>
              </div>
            </div>

            <div class="d-flex flex-column gap-3">
              <p class="">Dangerous Goods</p>
              <div class="d-flex align-items-center gap-5">
                <label class="radio-button-container">None
                  <input type="radio" checked="checked" name="radio"/>
                  <span class="checkmark"></span>
                </label>
                <label class="radio-button-container">Contains battery / Glass / Liquid
        ...
        <div class="warranty-section">
          <div class="inner-warranty-section">
            <div class="row">
              <div class="col-6">
                <div class="warranty-select">
                  <div class="box">
                    <label class="warranty-select-label">Warranty Type
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                          fill="none">
                          <path
              ...
              <div class="col-6">
                <div class="warranty-select">
                  <div class="box">
                    <label class="warranty-select-label">Duration</label>
                    <select class="wide selectize">
                      <option data-display="Select">Select</option>
                      <option value="1">Some option</option>
                      <option value="2">Another option</option>
            ...
            <div class="row">
              <div class="col-12">
                <div class="inner-input">
                  <label class="label" for="">Warranty Policy</label>
                  <input class="input" type="number" name="" id="" placeholder="Write here" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="add-product-footer mt-5">
        <div class="d-flex align-items-center gap-3">
          <a href="./add-Product6.html" class="save-draft-btn active">
            Save Draft
          </a>

          <Link href="/add-product-congratulation" class="confirm-btn active">
            Confirm
          </Link>
        </div>
      </div>
