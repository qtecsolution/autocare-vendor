                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="product-info-inner">
                                                <div class="product-info">
                                                    <input class="table-body-checkbox" type="checkbox" id="table-body-checkbox6" />
                                                    <label class="d-flex align-items-center flex-shrink-0" for="table-body-checkbox6"
                                                        tabindex="4">
                                                        <img class="product-image" src="./assets/images/products6.png" alt="Product Image" />
                                                    </label>
                                        ...
                                        <tr>
                                            <td class="product-info-inner">
                                                <div class="product-info">
                                                    <input class="table-body-checkbox" type="checkbox" id="table-body-checkbox7" />
                                                    <label class="d-flex align-items-center flex-shrink-0" for="table-body-checkbox7"
                                                        tabindex="4">
                                                        <img class="product-image" src="./assets/images/products7.png" alt="Product Image" />
                                                    </label>
