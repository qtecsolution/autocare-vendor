...
function NotificationPage({ allNotification, pageProps, calculatedTotalPages }) {
  ...
  return (
    <main id="content">
      <div className="inner-content">
        <section className="page-top-section">
          <div className="page-top-section-inner">
            ...
            <a href="./notification.html" className="notification-svg active">
        ...
        <div className="notification-inner">
          ...
          <div className="d-flex flex-column gap-3">
            {allNotification?.props?.notifications?.results?.map((notification) => (
              <div className="notification-inner-cart" key={notification?.id}>
                  ...
                  <div className="cart-content">
                    <div className="d-flex flex-column gap-2">
                      <div className="d-flex flex-column gap-1">
                        <h3 className="title">{notification?.message} <span>#{notification?.order_item_id}</span></h3>
      ...
      <section className="pagination-section">
        <div className="pagination-section-inner d-flex justify-content-center mt-2">
          <div className="right">
            <Pagination
