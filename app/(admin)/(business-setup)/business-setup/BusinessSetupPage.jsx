...
function BusinessSetupPage() {
  ...
  const complete2ndStep = async (e) => {
    e.preventDefault();
    if (businessType !== 1 && !timeSlots[0].closingTime || !timeSlots[0].openingTime) {
      toast.custom((t) => (
        <AlertToast
  ...
  function check1stButtonDisable() {
    if (!businessName || !location || !selectedDivision || !selectedDistrict || !selectedCity) {
      return true;
    } else {
      return false;
    }
  ...
  function check2ndButtonDisable() {
    if (!timeSlots[0].closingTime || !timeSlots[0].openingTime) {
      return true;
    } else {
      return false;
    }
            ...
            <div className="setup-store-section-inner">
              <div className="d-flex justify-content-center">
                <div className="center">
                  ...
                  <div className="setup-store-form">
                    <div className="inner-input">
                      <label className="input-label" for="BusinessName">{businessType === 1 ? 'Store' : businessType === 2 ? 'Garage' : 'Store/Garage'} Name <span className='text-danger'>*</span></label>
                    ...
                    <div className="inner-input">
                      <label className="input-label" for="Address">Location <span className='text-danger'>*</span></label>
                    ...
                    <div >
                      <label className="category-select-label">Division  <span className='text-danger'>*</span></label>
                      <Select
                    ...
                    <div >
                      <label className="category-select-label">District  <span className='text-danger'>*</span></label>
                      <Select
                    ...
                    <div >
                      <label className="category-select-label">Thana  <span className='text-danger'>*</span></label>
                      <Select
                        value={selectedCity}
                    ...
                    <button onClick={complete1stStep} className={`login-btn ${check1stButtonDisable() ? 'show_disable_button' : ''}`} disabled={check1stButtonDisable()}>
                      Save & Continue
                    </button>
                  </div>
                </div>
                  ...
                  <div className="setup-store-form" >
                    {timeSlots.map((slot, index) => (
                      <div className="row" key={index}>
                        <div className="col-4">
                          <div >
                            <label className="category-select-label">Time Slot <span className='text-danger'>*</span></label>
                            <Select
                        ...
                        <div className="col-4">
                          <div className="inner-input">
                            <label className="input-label" htmlFor={`openingTime-${index}`}>Opening Time <span className='text-danger'>*</span></label>
                            <div className="input-field">
                              <input
                                type="time"
                        ...
                        <div className="col-4">
                          <div className="inner-input">
                            <label className="input-label" htmlFor={`closingTime-${index}`}>Closing Time <span className='text-danger'>*</span></label>
                            <div className="input-field">
                              <input
                                type="time"
                    ...
                    <button className={`login-btn ${check2ndButtonDisable() ? 'show_disable_button' : ''}`} onClick={complete2ndStep} disabled={check2ndButtonDisable()}>
                      Save
                    </button>
                  </div>
                </div>
